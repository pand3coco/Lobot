...
(async function () {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "тнιѕ вσт ωαѕ мα∂є ву вєя" : global.config.BOTNAME}`, "[ BOT INFO ]");
